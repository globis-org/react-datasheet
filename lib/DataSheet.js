...
var DataSheet = function (_PureComponent) {
  ...
  function DataSheet(props) {
    ...
    _this.shouldUseIEClipboardApi = _this.shouldUseIEClipboardApi.bind(_this);
    _this.handleIECopy = _this.handleIECopy.bind(_this);
    _this.handleIEPaste = _this.handleIEPaste.bind(_this);
  ...
  _createClass(DataSheet, [{
    ...
    key: 'shouldUseIEClipboardApi',
    value: function shouldUseIEClipboardApi() {
      return 'clipboardData' in window;
    }
  }, {
    key: 'handleIECopy',
    value: function handleIECopy(e) {
      if ((e.keyCode == _keys.C_KEY || e.which == _keys.C_KEY) && e.ctrlKey) {
        this.handleCopy(e);
      }
    }
  }, {
    key: 'handleIEPaste',
    value: function handleIEPaste(e) {
      if ((e.keyCode == _keys.V_KEY || e.which == _keys.V_KEY) && e.ctrlKey) {
        this.handlePaste(e);
      }
    }
  }, {
